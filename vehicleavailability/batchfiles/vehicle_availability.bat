...
call emme -ng --set-iks 127.0.0.1 000 -m macros\9_convert_hhemp_va_cross_classification.mac
call emme -ng --set-iks 127.0.0.1 000 -m macros\15_vehicle_availability_summary.mac
cd ..
