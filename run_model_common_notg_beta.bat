...
call batchfiles\setup\model_run_reset_notg_beta.bat
REM delete matrices
call batchfiles\deletefiles\delete_matrix_files_notg.bat
REM delete existing files
call batchfiles\deletefiles\delete_summary_report_files_notg.bat
...
REM
REM run model setup
call batchfiles\setup\model_setup_notg_beta.bat
