...
call emme -ng --set-iks 127.0.0.1 000 -m macros\3-9_initialize_md_vdfs.mac %highpnr%
...
call emme -ng --set-iks 127.0.0.1 000 -m macros\6_calculate_md_bus_vehicle_equivalents.mac
cd ..\..