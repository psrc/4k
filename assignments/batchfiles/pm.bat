...
REM Runs the PM Auto, Transit and Walk and Bike Assignments
...
if %iternum% == 0 (
     call emme -ng 000 -m ..\macros\6_walk_bike_assignment.mac p 1003
)

call emme -ng 000 -m ..\macros\7_transit_assignment.mac p 1003
