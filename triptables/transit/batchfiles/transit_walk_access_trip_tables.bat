...
call emme -ng --set-iks 127.0.0.1 000 -m macros\9-1_transit_walk_access_mode_choice_summary.mac 3700 3701 3750 3751 4000
call emme -ng --set-iks 127.0.0.1 000 -m macros\10_construct_md_transit_walk_access_trip_tables.mac
call emme -ng --set-iks 127.0.0.1 000 -m macros\10-1_transit_walk_access_mode_choice_summary.mac 3700 3701 3750 3751 4000
call emme -ng --set-iks 127.0.0.1 000 -m macros\11_construct_pm_transit_walk_access_trip_tables.mac
call emme -ng --set-iks 127.0.0.1 000 -m macros\11-1_transit_walk_access_mode_choice_summary.mac 3700 3701 3750 3751 4000
call emme -ng --set-iks 127.0.0.1 000 -m macros\12_construct_ev_transit_walk_access_trip_tables.mac
call emme -ng --set-iks 127.0.0.1 000 -m macros\12-1_transit_walk_access_mode_choice_summary.mac 3700 3701 3750 3751 4000
call emme -ng --set-iks 127.0.0.1 000 -m macros\13_construct_ni_transit_walk_access_trip_tables.mac
call emme -ng --set-iks 127.0.0.1 000 -m macros\13-1_transit_walk_access_mode_choice_summary.mac 3700 3701 3750 3751 4000
cd..
